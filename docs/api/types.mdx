...
description: "Complete reference for every TypeScript type exported by mcp-watchtower: ToolSchema, Finding, StaticReport, and StaticAnalyzerConfig."
---

`mcp-watchtower` exports four TypeScript interfaces. You can import any of them as types alongside the `StaticAnalyzer` class. This page documents every field, its type, and its meaning.
